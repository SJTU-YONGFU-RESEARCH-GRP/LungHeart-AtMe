...
class Tower(nn.Module):
    ...
    def __init__(self, num):
        ...
        self.ResNet_II_7 = ResBlock(64, 64)
        self.norm0 = norm(64)
    ...
    def forward(self, x):
        # print("[ Tower ] before train_model:", x.shape)
        x = self.ResNet_I_0(x)
        # print('[ Tower ] after ResNet_0_1:', x.shape)
        x = self.ResNet_II_0(x)
        x = self.dropout(x)
        # print('[ Tower ] after ResNet_0:', x.shape)
        x = self.ResNet_II_1(x)
        x = self.dropout(x)
        # print('[ Tower ] after ResNet_1:', x.shape)
        ...
        x = self.dropout(x)
        # print('[ Tower ] after ResNet_5:', x.shape)
        ...
        # x = self.tanh0(x)
        x = self.relu0(x)
        # print("[ Tower ] after relu:", x.shape)
        ...
        x = self.flat(x)
        # print('[ Tower ] after flat:', x.shape)
        x = self.classifier(x)
        # print('[ Tower ] after classifier:', x.shape)
